...
export const config = {
    ...
    capabilities: [{
        ...
        'appium:app': path.join(process.cwd(), 'apps', 'wdiodemoapp.app'),
    ...
    before: async function (capabilities) {
        ...
        allureReporter.addEnvironment('Automation Engine', capabilities['appium:automationName'] || 'N/A');
    },
    ...
    afterTest: async function (test, context, { passed }) {
        if (!passed) {
            ...
            // anexa o mesmo screenshot dentro do relatório Allure
            const screenshotBuffer = fs.readFileSync(screenshotPath);
            allureReporter.addAttachment('Screenshot da falha', screenshotBuffer, 'image/png');

            // anexa logs do servidor, se disponíveis
            try {
                ...
                // alguns drivers/plataformas não suportam esse tipo de log — ignora
            }
        }
    },
